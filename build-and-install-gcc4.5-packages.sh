...
_copy_data_to_repo opt-mingw-i686-gcc4.5 opt-mingw-i686-gcc4.5-libs \
  opt-mingw-i686-gcc4.5-fortran opt-mingw-i686-gcc4.5-libgfortran opt-mingw-i686-gcc4.5-objc && \
MINGW_ARCH="mingw64" makepkg-mingw -Lf --install --noconfirm && \
_copy_data_to_repo opt-mingw-x86_64-gcc4.5 opt-mingw-x86_64-gcc4.5-libs \
  opt-mingw-x86_64-gcc4.5-fortran opt-mingw-x86_64-gcc4.5-libgfortran opt-mingw-x86_64-gcc4.5-objc
