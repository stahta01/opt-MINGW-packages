...
_copy_data_to_repo opt-mingw-i686-gcc4.4 opt-mingw-i686-gcc4.4-libs \
  opt-mingw-i686-gcc4.4-fortran opt-mingw-i686-gcc4.4-libgfortran opt-mingw-i686-gcc4.4-objc && \
MINGW_ARCH="mingw64" makepkg-mingw -Lf --install --noconfirm && \
_copy_data_to_repo opt-mingw-x86_64-gcc4.4 opt-mingw-x86_64-gcc4.4-libs \
  opt-mingw-x86_64-gcc4.4-fortran opt-mingw-x86_64-gcc4.4-libgfortran opt-mingw-x86_64-gcc4.4-objc
