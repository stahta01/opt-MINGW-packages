...
_copy_data_to_repo opt-mingw-i686-gcc4.3 opt-mingw-i686-gcc4.3-libs \
  opt-mingw-i686-gcc4.3-fortran opt-mingw-i686-gcc4.3-libgfortran opt-mingw-i686-gcc4.3-objc
